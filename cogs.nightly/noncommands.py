...
class Noncommands(commands.Cog):
    ...
    async def on_member_join(self, member: discord.Member):
        with open(rf"../pengaelicbotnightly.data/configs/{member.guild.id}.json", "r") as optionsfile:
    ...
    async def on_message(self, message):
        try:
            with open(rf"../pengaelicbotnightly.data/configs/{message.guild.id}.json", "r") as optionsfile:
                allOptions = load(optionsfile)
        except:
            pass
        ...
        if allOptions["toggles"]["censor"] == True:
            try:
                open(rf"../pengaelicbotnightly.data/censorfilters/{message.guild.id}.txt", "x").close()
                print("Censor file created for " + str(message.guild.name))
            except FileExistsError:
                pass
            with open(rf"../pengaelicbotnightly.data/censorfilters/{message.guild.id}.txt", "r") as bads_file:
