...
```""")
    ...
    async def namegen(self, ctx, amount: int=1, syllableLimit: int=3):
        ...
        for _ in range(amount):
            syllables = ["a","ae","ag","ah","al","am","an","art","as","au","ayn","az","be","bi","bo","bor","burn","by","ca","car","cat","cer","cha","co","cu","da","dam","dan","del","der","des","di","dil","do","don","dy","dyl","e","el","em","en","ex","fi","fin","finn","fly","fu","ga","go","gor","grif","gy","he","hy","i","ig","il","in","is","iss","ja","ji","jo","jor","ka","kes","kev","kla","ko","lan","lar","ler","li","lo","lu","ly","ma","mar","me","mel","mi","mo","mol","mu","mus","na","nar","ne","no","nor","nos","o","ob","ok","ol","om","on","or","os","pe","pen","per","pu","ra","ral","ran","ras","re","res","rez","ri","rin","rob","ry","sa","sac","sam","san","sans","ser","sey","sha","sky","son","st","str","stra","ta","tam","tay","ter","tha","than","tif","ti","tin","to","tor","tur","u","um","un","ur","va","wa","wyn","yu","za","zal","ze","zi","zil","zo","zu"]
