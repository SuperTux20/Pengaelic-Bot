...
class Options(commands.Cog):
    ...
    async def showfilter(self, ctx):
        with open(rf"../pengaelicbotnightly.data/censorfilters/{ctx.guild.id}.txt", "r") as bads_file:
    ...
    async def addfilter(self, ctx, word2add):
        with open(rf"../pengaelicbotnightly.data/censorfilters/{ctx.guild.id}.txt", "r") as bads_file:
            ...
            if word2add in all_bads:
                ...
                with open(rf"../pengaelicbotnightly.data/censorfilters/{ctx.guild.id}.txt", "w") as bads_file_to:
    ...
    async def wipefilter(self, ctx):
        if self.wipecensorcinfirm == False:
            ...
            open(rf"../pengaelicbotnightly.data/censorfilters/{ctx.guild.id}.txt", "w").close()
